...
class ncacn_packet(__talloc.Object):
    # no doc
    ...
    auth_length = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    call_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    drep = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    frag_length = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    rpc_vers_minor = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
