...
class bind_nak(__talloc.Object):
    # no doc
    ...
    num_versions = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    reject_reason = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
